...
const update = async (id, information) =>{
    const { venta_id,fecha_cita,hora_inicio,hora_termino,estado,usuario_id } = information;
...
export const appointmentModel = {getAll,getById,searchByRut,deleteAppointment,update,create}